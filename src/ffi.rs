...
pub const SCARD_E_INSUFFICIENT_BUFFER: LONG = 0x80100008;
...
pub const SCARD_W_CACHE_ITEM_NOT_FOUND: LONG = 0x80100070;
pub const SCARD_W_CACHE_ITEM_STALE: LONG = 0x80100071;
pub const SCARD_W_CACHE_ITEM_TOO_BIG: LONG = 0x80100072;
...
pub const SCARD_AUTOALLOCATE: DWORD = (-1 as LONG) as DWORD;
